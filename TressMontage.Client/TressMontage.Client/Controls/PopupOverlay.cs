...
namespace TressMontage.Client.Controls
{
    ...
    ///     Class PopupOverlay.
    /// </summary>
    public class PopupOverlay : ContentView
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PopupOverlay"/> class.
        /// </summary>
        public PopupOverlay()
        {
        ...
        public new static BindableProperty ContentProperty = BindableProperty.Create(nameof(Content), typeof(View), typeof(PopupOverlay),
        ...
        {
            var obj = bindable as PopupOverlay;
        ...
        public void ShowPopup(View popupView, Constraint xConstraint, Constraint yConstraint, Constraint widthConstraint = null, Constraint heightConstraint = null)
        {
            ...
            base.Content.HeightRequest = 400;
            base.Content.WidthRequest = 400;
            base.Content.BackgroundColor = Color.Lime;
        }
